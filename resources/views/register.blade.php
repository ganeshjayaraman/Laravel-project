        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    {!! Form::open(array('url'=>array('formregister', Auth::user()->id),'id' => 'formregister','name'=>'formregister','class' => 'form-horizontal')) !!}
						...
						<div class="form-group{{ $errors->has('dateofjoin') ? ' has-error' : '' }}">
                            <label for="dateofjoin" class="col-md-4 control-label">Date Of Join</label>

                            <div class="col-md-6">
                                <input id="dateofjoin" type="date" class="form-control" name="dateofjoin" value="{{ old('name') }}">
